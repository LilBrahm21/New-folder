...
print("Your rent is \$", rent:.2f, "which is", rent_percentage, "of your income.")
# Your groceries is $XX.XX which is XX% of your income. (print)
print("Your utilities is \$", utilities:.2f "which is", utilities_percentage:.2f "of your income.")
# Your transportation is $XX.XX which is XX% of your income. (print)
print("Your groceries is \$",groceries:.2f, "which is", groceries_percentage:.2f "of your income.")  
# Your savings is $XX.XX which is XX% of your income. (print)
print("Your transportation is \$",transportation:.2f, "which is", transportation_percentage:.2f "of your income.")
# Your spendings is $XX.XX which is XX% of your income. (print)
print("Your spending is \$",spending:.2f, "which is", spending_percentage:.2f "of your income.") 
# Your savings is $XX.XX which is XX% of your income. (print)
print("Your saving is \$",saving:.2f, "which is", saving_percentage:.2f "of your income.")  